    ...
    <div>
      ...
      <div className="grid lg:grid-cols-3 mx-10 ">
        ...
        >
          ...
          <div className=" w-full  my-auto lg:p-20 md:p-14 sm:p-12 px-10 text-center absolute lg:bottom-44 md:bottom-40 sm:bottom-32 bottom-28  text-[#FFFFFF] grid justify-items-start ">
            <h1 className="lg:mb-5 mb-2 lg:text-xl md:text-xl sm:text-lg text-xs text-left">NEW YEAR, NEW BOOKS</h1>
            <h1 className="lg:mb-5 mb-2  font-bold lg:text-5xl md:text-5xl sm:text-4xl text-2xl text-left">
            ...
            <button className="bg-white lg:px-14 md:px-14 sm:px-10 px-4 lg:mb-5 md:mt-5 mt-5 rounded-full text-black hover:text-white hover:outline outline-1  outline-white lg:py-3 md:py-3 sm:py-3 py-1 lg:text-lg  text-sm hover:bg-[#F44344] ">
              See More
            </button>
          </div>
        </div>
