  ...
  return (
    <div className="mx-10 mb-16">
      ...
      <Carousel itemsToShow={1}>
        <Item>
          <section className="my-8 mx-8 dark:bg-white dark:text-black drop-shadow-xl">
            <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
              ...
              <p className="px-6 py-2  font-semibold text-center sm:font-bold md:text-4xl sm:text-3xl text-lg lg:max-w-2xl xl:max-w-4xl dark:text-black">
              ...
              <div className="flex justify-center space-x-3">
                <img
                  src={img1}
                  alt=""
                  className="sm:w-20 sm:h-20 w-14 h-14 bg-center bg-cover rounded-md dark:bg-gray-500 dark:bg-gray-700"
                />
                <div>
        ...
        <Item>
          <section className="my-8 dark:bg-white dark:text-black drop-shadow-xl">
            <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              ...
              <div className="flex justify-center space-x-3">
                ...
                />
                <div>
                  <p className="leadi">Angelina Gomes</p>
                  <p className="text-sm leadi dark:text-gray-600">
                  Houston
                  </p>
                  <a
                    className="flex items-center py-2 space-x-1 text-sm dark:text-[#F44344]"
                    href="/"
                  >
                    <span>Read full story</span>
                    <svg
          ...
          <section className="my-8 dark:bg-white dark:text-black drop-shadow-xl">
            <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
              ...
              <div className="flex justify-center space-x-3">
                ...
                />
                <div>
                  <p className="leadi">Debanjan Roy</p>
                  <p className="text-sm leadi dark:text-gray-600">
                  Los Angeles
                  </p>
                  <a
          ...
          <section className="my-8 dark:bg-white dark:text-black drop-shadow-xl">
            <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
              ...
              <div className="flex justify-center space-x-3">
                ...
                />
                <div>
                  <p className="leadi">Kelli hansen</p>
                  <p className="text-sm leadi dark:text-gray-600">
                  New York
                  </p>
                  <a
          ...
          <section className="my-8 dark:bg-white dark:text-black drop-shadow-xl">
            <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
              ...
              <div className="flex justify-center space-x-3">
                ...
                />
                <div>
                  <p className="leadi">Jonhey Depp</p>
                  <p className="text-sm leadi dark:text-gray-600">
                  Philadelphia
                  </p>
                  <a
